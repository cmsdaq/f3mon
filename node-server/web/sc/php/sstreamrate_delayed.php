...
$data = '{"query":{"bool":{"must":[{"wildcard":{"stream":"'.$stream.'"}},{"range":{"ls":{"from":'.$lsstart.',"to":"'.$lsend.'"}}},{"term":{"completion":1.0}},{"term":{"_parent":'.$run.'}}]}},"sort":{"ls":"desc"},"aggs":{"lss":{"terms":{"field":"ls","size":15,"order" : { "_count" : "asc" }},"aggs":{"tot":{"sum":{"field":"out"}}}}}}';
