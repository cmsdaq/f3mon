...
$data = '{"query":{"bool":{"must":[{"wildcard":{"stream":"'.$stream.'"}},{"range":{"ls":{"from":'.$lsstart.',"to":"'.$ls.'"}}},{"term":{"completion":1.0}},{"term":{"_parent":'.$run.'}}]}},"sort":{"ls":"desc"},"aggs":{"lss":{"terms":{"field":"ls","size":1000},"aggs":{"tot":{"sum":{"field":"out"}}}}}}';
