...
$data = '{"query":{"bool":{"must":[{"parent_id":{"type":"stream-hist","id":'.$run.'}},{"range":{"completion":{"gt":0.99}}}]}},"aggs":{"pippo":{"terms":{"field":"stream","size":200},"aggs":{"pippo2":{"terms":{"field":"ls","order":{"_term":"desc"},"size":1},"aggs":{"pippo3":{"sum":{"field":"'.$var.'"}}}}}}}}';
