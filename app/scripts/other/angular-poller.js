        ...
        .factory('poller', [
            ...
            function(
                ...
                Poller.prototype.start = function() {
                    ...
                    var timestamp;
                    this.paused = false;
                    //global pause is used to override single poller resume
                    if (angular.isUndefined(this.pausedGlobal))
                      this.pausedGlobal = false;
                 ...
                 * Force pause poller
                 */
                Poller.prototype.pauseGlobal = function() {
                    this.pausedGlobal = true;
                };

                /**
                 * Allow resume of force paused poller
                 */
                Poller.prototype.resumeGlobal = function() {
                    this.pausedGlobal = false;
                };
